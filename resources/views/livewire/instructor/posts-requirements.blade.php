<section>
    <h1 class="text-2xl font-bold">Requerimientos del Post</h1>
    <hr class="mt-2 mb-6">
    @foreach($post->requirements as $item)
    <article class="card mb-4 shadow-md">
        <div class="card-body bg-gray-100 rounded-lg text-gray-600 px-5 py-6 shadow-md">
            @if ($requirement->id==$item->id)
            <form wire:submit.prevent="update">
                <input wire:model="requiriment.name" class="form-input w-full rounded-lg">
    ...
    <article class="card">
        <div class="card-body bg-gray-100 rounded-lg text-gray-600 px-5 py-6">
           <form wire:submit.prevent="store">
            <input wire:model="name" class="text-sm form-input w-full rounded-lg" placeholder="Agregar el nombre de un requerimiento">
            ...
            <div class="flex justify-end mt-2">
                ...
                rounded-lg">Agregar Requerimiento</button>
            </div>
           </form>
        </div>
    </article>
